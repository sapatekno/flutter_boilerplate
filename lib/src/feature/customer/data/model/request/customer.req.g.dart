...
abstract class _$CustomerReqCWProxy {
  ...
  CustomerReq merekMeter(String? merekMeter);

  CustomerReq nomorMeter(String? nomorMeter);

  CustomerReq petugas(String? petugas);

  CustomerReq photo(String? photo);

  CustomerReq rst(String? rst);
...
class _$CustomerReqCWProxyImpl implements _$CustomerReqCWProxy {
  ...
  @override
  CustomerReq merekMeter(String? merekMeter) => this(merekMeter: merekMeter);

  @override
  CustomerReq nomorMeter(String? nomorMeter) => this(nomorMeter: nomorMeter);

  @override
  CustomerReq petugas(String? petugas) => this(petugas: petugas);

  @override
  CustomerReq photo(String? photo) => this(photo: photo);

  @override
  CustomerReq rst(String? rst) => this(rst: rst);
...
CustomerReq _$CustomerReqFromJson(Map<String, dynamic> json) => CustomerReq(
  akurasi: (json['akurasi'] as num?)?.toDouble(),
      ...
      merekMeter: json['merekMeter'] as String?,
...
Map<String, dynamic> _$CustomerReqToJson(CustomerReq instance) => <String, dynamic>{
      ...
      'merekMeter': instance.merekMeter,
      'nomorMeter': instance.nomorMeter,
      'petugas': instance.petugas,
      'photo': instance.photo,
      'rst': instance.rst,
      'sl': instance.sl,
      'sr': instance.sr,
      'standAkhir': instance.standAkhir,
